...
function Map() {
  return (
    <>
    <div className='font-serif ml-28 md:ml-0 bg-orange-50 md:h-[530px] lg:h-[520px] md:grid md:grid-cols-2 md:grid-rows-2 rounded-xl'>
       <div className='md:col-start-1 md:row-start-1'>
          <img className='rounded-2xl p-3 md:h-[400px] md:mt-14 md:ml-14' src={img} alt="" />
       </div>
